  ...
  <div class="w3-row">
    ...
    {{--  <div class="w3-card w3-round">
      ...
      <br>--}}
       ...
       <div class="w3-card w3-round w3-white w3-center">
         <h6 class="pt-2"><b><i class="fas fa-user-ninja" style="font-size: 20px"></i>&nbsp;People You May Know</b></h6>
        <hr>
    ...
    <div class="w3-col m7">
        ...
        @csrf
             ...
             <div class="row">
               <div class="col-lg-10">
                ...
                <input type="file" class="form-control-user" name="photo[]" multiple>
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        <img src="{{$post->user->socialuser->photo}}" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
        <span class="w3-right "> 
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <div class="w3-col m2">
       ...
       <div class="w3-card w3-round w3-white w3-center">
        ...
        <h6 class="pt-2"><b><i class="fas fa-user-tie" style="font-size: 20px"></i>&nbsp;Online Users</b></h6>
        <hr>
      ...
      <div class="w3-card w3-round w3-white w3-center">
        <h6 class="pt-2"><b><i class="fas fa-users" style="font-size: 20px"></i>&nbsp;Friend Request</b></h6>
        <hr>
        <div class="w3-container" id="showfriend">
...
// }
  ...
  function people() {
    // setTimeout(function () {
       $('#people').load('{{route('showpeople')}}');          
       // people();
      // },100);
  }
  function showfriend() {
      setTimeout(function () {
          $('#showfriend').load('{{route('showfriend')}}');   
        showfriend();
      },1000);
